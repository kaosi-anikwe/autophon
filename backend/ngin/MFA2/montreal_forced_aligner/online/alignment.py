...
class OnlineAlignmentFunction(KaldiFunction):
    ...
    def cleanup_intervals(
        ...
        typing.List[CtmInterval], typing.List[CtmInterval], typing.List[int]
    ]:
        """
    ...
    def _run(
        self,
    ) -> typing.Tuple[typing.List[CtmInterval], typing.List[CtmInterval], float]:
        """Run the function"""
        ...
        with mfa_open(self.log_path, "w") as log_file:
            ...
            for utterance, intervals in parse_ctm_output(
                ...
                (
                    ...
                    phone_intervals,
                    phone_word_mapping,
                ) = self.cleanup_intervals(utterance, intervals, word_pronunciations)
                log_likelihood = None
