...
class AcousticModelTrainingMixin(
    ...
    def finalize_training(self) -> None:
        ...
        ali_model_path = self.working_directory.joinpath(
            f"{self.num_iterations+1}.alimdl"
        )
    ...
    def meta(self) -> MetaDict:
        ...
        data = {
            "phones": sorted(
                self._generate_non_positional_list(self.non_silence_phones)
            ),
            ...
            "dictionaries": {
                ...
                "default": self.worker.dictionary_base_names[
                    self.worker._default_dictionary_id
                ],
